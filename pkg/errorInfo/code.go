...
const (
	...
	ERROR_AUTH                                 = 20005
	ERROR_AUTH_PASSWORD_NOT_EQUAL_SUREPASSWORD = 20006

	ERROR_EMAIL_SEND_FAIL = 30001

	ERROR_VERIFI_CODE_CHECK_SUCEESS = 40000
	ERROR_VERIFI_CODE_CHECK_FAIL    = 40001
)
...
const (
	...
	ERROR_EMAIL_SEND_FAIL_CN                      = "邮件发送失败"
	ERROR_VERIFI_CODE_CHECK_SUCEESS_CN            = "验证码验证成功"
	ERROR_VERIFI_CODE_CHECK_FAIL_CN               = "验证码验证失败"
	ERROR_AUTH_PASSWORD_NOT_EQUAL_SUREPASSWORD_CN = "两次密码不同"
)
...
var ErrorMsgCN = map[int]string{
	...
	ERROR_EMAIL_SEND_FAIL:                      ERROR_EMAIL_SEND_FAIL_CN,
	ERROR_VERIFI_CODE_CHECK_SUCEESS:            ERROR_VERIFI_CODE_CHECK_SUCEESS_CN,
	ERROR_VERIFI_CODE_CHECK_FAIL:               ERROR_VERIFI_CODE_CHECK_FAIL_CN,
	ERROR_AUTH_PASSWORD_NOT_EQUAL_SUREPASSWORD: ERROR_AUTH_PASSWORD_NOT_EQUAL_SUREPASSWORD_CN,
}
